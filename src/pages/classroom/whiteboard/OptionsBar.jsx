 ...
 */
import { FONTS, FONT_SIZES, POLYGON_MIN, POLYGON_MAX } from './constants.js'
...
export default function OptionsBar({ tool, strokeWidth, onWidth, opacity, onOpacity, fontFamily, setFontFamily, fontSize, setFontSize, bold, setBold, polygonSides, setPolygonSides }) {
