...
export default function CourseApplyModal({ courseId, teacherName, onClose }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const isMileageShort = err?.code === 'INSUFFICIENT_CREDIT' || err?.status === 402
      setError(isMileageShort
        ? '마일리지가 부족해서 수강신청을 할 수 없습니다. 마일리지를 충전한 뒤 다시 신청해 주세요.'
        : (err.message || '신청 중 오류가 발생했습니다. 다시 시도해 주세요.'))
    } finally {
      setSubmitting(false)
    }
  }
      ...
      <div className="cd-modal-overlay" onClick={onClose}>
        <div className="cd-modal" onClick={e => e.stopPropagation()}>
          ...
          <div className="cd-modal__body" style={{ textAlign: 'center', padding: '40px 24px' }}>
            ...
            <p style={{ fontSize: 17, fontWeight: 800, marginBottom: 8 }}>신청이 전송되었어요.</p>
        ...
        <form className="cd-modal__body" onSubmit={handleSubmit}>
          ...
          <div className="cd-field">
            ...
            <textarea
              ...
              placeholder="예: 고등학교 2학년, 모의고사 수학 3등급입니다."
              required
            />
          </div>
          <div className="cd-field">
