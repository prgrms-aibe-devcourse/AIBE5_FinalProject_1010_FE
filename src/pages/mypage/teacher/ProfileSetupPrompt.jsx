...
export default function ProfileSetupPrompt({ userName, onClose, onGoProfile }) {
  ...
  return (
    <div className="ps-overlay" role="dialog" aria-modal="true" aria-labelledby="ps-title">
      <div className="ps-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <p className="ps-desc">
          수업 등록·강의실 열기 등의 기능은 <b></b><strong>인증</strong>이 완료된 선생님만 이용할 수 있어요.
          <br />
        </p>

        <div className="ps-actions">
          <button type="button" className="ps-btn ps-btn--primary" onClick={() => onGoProfile?.()}>
            프로필 관리하러 가기
          </button>
        </div>
